...
<h2 class="left-align">Sign-In</h2>
<p class="top">
    This API will be used for sign-in to system using phone number and password.
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>customerId</td>
            <td>attribute 'customerId' represents username for user</td>
        </tr>
        <tr>
            <td>password</td>
            <td>attribute 'password' represents user's password (not hashed)</td>
        </tr>
        <tr>
            <td>fcmToken</td>
