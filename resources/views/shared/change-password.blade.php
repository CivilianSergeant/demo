...
<h2 class="left-align">Change Password</h2>
<p class="top">
    This API will be used to change new password using old password and customer id
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/change-password</span>
</p>
<p class="top">
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>oldPassword</td>
            <td>attribute 'oldPassword' represents user's old password (not hashed)</td>
        </tr>
        <tr>
            <td>newPassword</td>
            <td>attribute 'newPassword' represents user's new password (not hashed)</td>
        </tr>
        <tr>
            <td>deviceType</td>
