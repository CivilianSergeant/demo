...
<h2 class="left-align">Set FCM Token</h2>
<p class="top">
    This API will be register token for FCM messaging
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/set-fcm-token</span>
</p>
<p class="top">
...
<script type="text/javascript">
    var data = {
        ...
        "token":"dOLs8aJUNlY:APA91bFy6sTUIezOd-3seRQ--gEoxJnr42UJU8NoydqAgImKvwv1bq9fWZvyWFS6NeLFdP1Zx1n57qzdFGeScmnk1k9xG5S9ReWkXFcVAJDCmHPfz9_OiUjHSPPYNWqXUv6CHaZ0gz7w",
        "customerId":1
    };
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>token</td>
            <td>attribute 'token' represents FCM token that should register to server</td>
        </tr>
        <tr>
            <td>customerId</td>
            <td>attribute 'customerId' represents subscriber's unique id. it is optional, can be set as null</td>
        </tr>
        </tbody>
    </table>
</div>
