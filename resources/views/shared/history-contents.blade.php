...
<h2 class="text-left">Get History Contents</h2>
<p class="top">
    Get History Contents API will fetch all those contents which are visited by customer.
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/history-contents
</p>
<p class="top">
