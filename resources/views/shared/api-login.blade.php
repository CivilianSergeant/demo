...
<h2 class="left-align">API Login</h2>
<p class="top">
    This API will be used for login to system if app switch state from background to foreground.
    It will be required for followings
        <ol>
            <li>If the state of app stay in background more than 60 minutes.</li>
            <li>If the state of app goes to restart from destroy state.</li>
        </ol>
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/api-login</span>
</p>
<p class="top">
