...
<h2 class="left-align">Get Bkash Info</h2>
<p class="top">
   This API should use to get BKash Information
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/bkash-info</span>
</p>
<p class="top">
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li>
                        <strong>bkashInfo</strong> - bkashInfo contains a JSONObject with following attribute
                        <br/>
                        <ol>
                            <li><strong><em>info</em></strong> - it will gives you insturction about bkash transaction</li>
                            <li><strong><em>merchantNumber</em></strong> - it will give you merchant number for bkash transaction</li>
                        </ol>
                    </li>
                </ul>
            </td>
