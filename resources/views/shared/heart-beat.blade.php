...
<h2 class="text-left">Get Heart Beat</h2>
<p class="top">
    By using this API remote App will get any kind of db version status.
    It will be required for followings
    <ol>
        <li>In All App state this api should use in every 30/60 seconds interval</li>
        <li>Send Type FORGROUND when application running in front</li>
        <li>Send Type BACKGROUND when application running in background</li>
    </ol>
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/heart-beat
</p>
<p class="top">
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>type</td>
            <td>attribute 'type' represents viewing type, possible values are [FOREGROUND | BACKGROUND] </td>
        </tr>
        <tr>
            <td>customerId</td>
        ...
        <tr>
            <td>lon</td>
            <td>attribute 'lon' represents longitude Subscriber's Phone</td>
        </tr>
        </tbody>
    </table>
</div>
