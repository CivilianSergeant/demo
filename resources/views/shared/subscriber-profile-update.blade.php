...
<h2 class="left-align">Set Subscriber Profile</h2>
<p class="top">
    This API will be used to update subscriber information.

</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/subscriber-profile-update</span>
</p>
<p class="top">
...
<script type="text/javascript">
    var data = {
        ...
        "version": 1.01,
        "apiName": "subscriberProfileUpdate",
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>fullname</td>
            <td>attribute 'fullname' represents subscriber's fullname</td>
        </tr>
        <tr>
            <td>email</td>
            <td>attribute 'email' represents subscriber's email</td>
        </tr>
        <tr>
            <td>phoneNo</td>
            <td>attribute 'phoneNo' represents subscriber's contact number</td>
        </tr>
        <tr>
            <td>address</td>
            <td>attribute 'address' represents subscriber's address</td>
        </tr>
        </tbody>
    </table>
</div>
