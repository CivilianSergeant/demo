...
<h2 class="text-left">Set Favorites</h2>
<p class="top">
    Set Favorites API should use to store content as favorite
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/set-favorites
</p>
<p class="top">
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>isFavorite</td>
            <td>attribute 'isFavorite' represents flag that 1 = for set as favorite and 0 = remove from favorite</td>
        </tr>
        </tbody>
    </table>
</div>
...
<script type="text/javascript">
    ...
    var data = {
        ...
        "response": {
            ...
            "balance":0,
            "message": "Content successfully updated favorite list",
            "messageType": "VIEW"
        },
        "errorCode": 0,
        "errorMsg": '',
