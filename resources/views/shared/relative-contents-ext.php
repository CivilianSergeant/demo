<h2 class="text-left">Get Relative Contents Ext</h2>
<p class="top">
    Get Relative Contents API will fetch all contents those are related by video-tag.
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/relative-contents-ext
</p>
<p class="top">
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>contentId</td>
            <td>attribute 'contentId' represents content id that is playing</td>
        </tr>
        <tr>
            <td>customerId</td>
        ...
        <tr>
            <td>videoTag</td>
            <td>attribute 'videoTag' used to find content by video tag</td>
        </tr>
        <tr>
            <td>limit</td>
