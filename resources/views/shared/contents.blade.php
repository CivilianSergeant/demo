...
<h2 class="text-left">Get Contents</h2>
<p class="top">
    Get Contents API will fetch all contents of given type.
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/contents
</p>
<p class="top">
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li><strong>channels[index].description</strong> - it will contain content's description which is base64 encoded, to get original text developer should decode value of this attribute</li>
