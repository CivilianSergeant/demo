...
<h2 class="left-align">Get System Settings</h2>
<p class="top">
    This API will fetch all system settings App should store this data in the device ,
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li><strong>confirmCodeTemplate</strong> - this message will be sent with code during code confirmation</li>
                </ul>
            </td>
        </tr>
        <tr>
