...
<h2 class="left-align">Get Service Operators</h2>
<p class="top">
    This API will fetch all service Operators from system and App should store this data as persistent in the device ,
    next it will use to verify content.
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/service-operators</span>
</p>
<p class="top">
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    <li><strong>count</strong> - number of serviceOperator exist into the collection <em>'serviceOperators'</em></li>
                    ...
                    <li><strong>serviceOperators</strong> - it will contain collection of serviceOperator as object.</li>
                    <li><strong>serviceOperators[index].telco_name</strong> - it will contain service operator's name.</li>
                    <li><strong>serviceOperators[index].telco_id</strong> - it will contain service operator's id.</li>
                    <li><strong>serviceOperators[index].telco_prefix</strong> - it will contain service operator's prefix.</li>
                </ul>
            </td>
        </tr>
        <tr>
