...
<h2 class="left-align">Get About Us</h2>
<p class="top">
   This API should use to get about us information
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/about-us</span>
</p>
<p class="top">
...
<script type="text/javascript">
    var data = {
        ...
        "response": {
            ...
            "ads": true,
            "adsType": 1,
            "aboutUs" : "here will be about us information"
        },
        "errorCode": 0,
        "errorMsg": '',
        "debugCode":0,
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li>
                        <strong>aboutUs</strong> - aboutUs contains a about us information
