...
<h2 class="left-align">Get Service Operator IDs</h2>
<p class="top">
    This API will fetch all service Operators id from system and App should store this data as persistent in the device ,
    next it will use to verify content. This is the short form of service operators api
</p>
...
<script type="text/javascript">
    var data = {
        ...
        "response": {
            ...
            "ads": true,
            "adsType": 1,
            "serviceOperatorId": "1,2,3,4,5,6,7,8,9"
        },
        "errorCode": 0,
        "errorMsg": '',
        "debugCode":0,
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li><strong>serviceOperatorId</strong> - it will contain id of service operator as (,) coma seperated valued , data type is string.</li>
                </ul>
            </td>
        </tr>
        <tr>
