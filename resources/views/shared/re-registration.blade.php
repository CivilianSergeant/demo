    ...
    <h2 class="left-align">Re-Registration</h2>
        <p class="top">
            Re-Registration API should use for the purpose of re-registering a subscriber to the system.
        ...
        <p class="top">
            <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/re-registration</span>
        </p>
        <p class="top">
