<h2 class="left-align">Purchase Package By Wallet</h2>
<p class="top">
    This API will be used for purchase package using wallet payment method.
    
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <span><strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/purchase-package-by-wallet</span>
</p>
<p class="top">
...
<script type="text/javascript">
    var data = {
        ...
        "version": 1.01,
        "apiName": "purchasePackageByWallet",
...
<div class="">
    ...
    <table class="table">
        ...
        <tr>
            <td>packageId</td>
            <td>attribute 'packageId' represents id of package that will be purchase</td>
        </tr>
        <tr>
            <td>paymentMethod</td>
    ...
    var data = {
        ...
        "response": {
           ...
           "transaction": {
                ...
                "packageId": 1,
                "price": "0",
                "packageStartDate": "2017-01-22 13:16:08",
                "packageExpireDate": "2017-02-21 23:59:59",
                "duration": "30",
                "transactionDate": "2017-01-22 07:16:08"
            },
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li>
                        ...
                        <ol>
                            ...
                            <li><strong><em>transaction.packageId</em></strong> - purchased package id</li>
                            <li><strong><em>transaction.price</em></strong> - price debit from user account</li>
                            <li><strong><em>transaction.packageStartDate</em></strong> - package subscription start date</li>
                            <li><strong><em>transaction.packageExpireDate</em></strong> -  package subscription expire date </li>
