...
<h2 class="text-left">Get Subscribed Packages</h2>
<p class="top">
    Get Subscribed Packages API will fetch all subscribed packages for a customer.
</p>
<hr style="border:1px solid #ccc"/>
<p class="top">
    <strong>Request URL:</strong> http:// [ ServerIp]: [serverPort]/subscribed-packages
</p>
<p class="top">
            ...
            "subscribedPackages": [
                {
                    ...
                    "package_start_date":"2016-10-20 06:45:29",
                    "package_expire_date":"2016-10-20 23:59:59"
        ...
        <tr>
            ...
            <td>attribute 'response' will hold actual response for the request url, it also contain
                ...
                <ul style='list-style:none;padding:0;'>
                    ...
                    <li><strong>subscribedPackages</strong> - it will contain collection of package as object</li>
                    <li><strong>subscribedPackages[index].id</strong> - it represents unique id for a package</li>
                    <li><strong>subscribedPackages[index].package_name</strong> - it represents package name</li>
                    <li><strong>subscribedPackages[index].package_type</strong> - it represents package type, possible values are [LIVE | VOD | CATCHUP]</li>
                    <li><strong>subscribedPackages[index].duration</strong> - it represents duration of package</li>
                    <li><strong>subscribedPackages[index].price</strong> - it represents package price</li>
                    {{--<li><strong>packages[index].programs</strong> - it represents how many content or program included</li>--}}
                    <li><strong>subscribedPackages[index].package_mobile_logo</strong> - it represents logo url for mobile</li>
                    <li><strong>subscribedPackages[index].package_poster_mobile</strong> - it represents poster url for mobile</li>
                    <li><strong>subscribedPackages[index].package_stb_logo</strong> - it represents logo url for stb/web</li>
                    <li><strong>subscribedPackages[index].package_poster_stb</strong> - it represents poster url for stb/web</li>
                    <li><strong>subscribedPackages[index].package_start_date</strong> - it represents start date of package subscription</li>
                    <li><strong>subscribedPackages[index].package_expire_date</strong> - it represents expire date of package subscription</li>
                </ul>
            </td>
        </tr>
        <tr>
